...
## Observations
The outputs changed depending on the structure of the prompt. The first response was short and explanatory, while the second response was formatted into bullet points. This demonstrates how prompt design affects formatting, tone, and level of detail, which is important when using LLMs programmatically.
